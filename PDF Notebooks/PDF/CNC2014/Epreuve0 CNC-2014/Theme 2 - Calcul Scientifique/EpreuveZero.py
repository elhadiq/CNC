...
def secante_iter(xn_1, xn , f, epsilon):
...
print("Secante Récursive:   Abscisse d'un zéro de log(x)-x^3+4 dans [%d;%d] : %.18f" % (xa, xb, x0))
print(f(x0))

print('-------------------------------------------------------')
x0 = secante_iter(xa, xb, f, epsilon)
print("Secante Iterative:  Abscisse d'un zéro de log(x)-x^3+4 dans [%d;%d] : %.18f" % (xa, xb, x0))
print(f(x0))
...
a=1
b=2
x0=lagrange(f,a,b,1000)
print("fausse position x=",x0)
